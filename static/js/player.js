$("#music").append('<div id="xplayer"><div class="player"><div class="cover xf_glass"></div><div class="info"><div class="songstyle"><span class="song"><span></div><div class="artiststyle">--&nbsp;<span class="artist"></span></div></div><div id="Lrc"class="show"></div><div class="foot"><div class="playprogress"title="00:00 / 00:00"><div class="progressbg"><div class="progressbg1"></div><div class="progressbg2"></div><div class="ts"></div></div></div><div class="time"></div><div class="switch-playlist"><i class="fa fa-list-ul"></i></div></div><div class="control"><i class="prev fa iconfont">&#xe603;</i><div class="status"><i class="play fa fa-play"></i><i class="pause fa fa-pause"></i></div><i class="next fa iconfont">&#xe602;</i></div></div><div class="playlist"><div class="playlist-bd"><div class="album-list"><div class="musicheader"></div><div class="list"></div></div><div class="song-list"><div class="musicheader"><i class="fa fa-angle-right"></i><span></span></div><div class="list"><span></span></div></div></div></div></div>');
...
if (css(span, "font-family") === "FontAwesome") {
    ...
    $("head")
        .append("<link rel='stylesheet' id='font-awesome-css'  href='https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.min.css' type='text/css' media='all' />")
};
...
$.ajax({
    ...
    success: function(data) {
        ...
        // 	$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + api + "/Static/player3/css/player.css\">");
        // } else if (playerinfo.showColors == "1") {
        // 	$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + api + "/Static/player3/css/player2.css\">");
        // }
        // if (playerinfo.showColors == "0") {
        // 	$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"/static/Player-GlassUI/css/player.css\">");
        // }
        // else if (playerinfo.showColors == "1") {
        // 	$("head").append("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + api + "/Static/player3/css/player2.css\">");
        // }
